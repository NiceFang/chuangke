...
//            userAward($uid,'zhuandj1',3,$pay_money);
            ...
            $userInfo = M('user')->where(array('userid' => $uid))->Field('use_grade,is_degraded,is_center')->find();
            $sellInfo = M('user')->where(array('userid' => $order['order_sellerid']))->field('is_center')->find();
